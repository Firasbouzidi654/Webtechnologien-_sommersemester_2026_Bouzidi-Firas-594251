...
import de.htw_berlin.KinderCareConnect.business.error.EmailAlreadyExistsException;
import de.htw_berlin.KinderCareConnect.business.error.InvalidCredentialsException;
import de.htw_berlin.KinderCareConnect.persistence.entity.UserEntity;
import de.htw_berlin.KinderCareConnect.persistence.repository.AppUserRepository;
import de.htw_berlin.KinderCareConnect.rest.model.auth.AuthResponse;
import de.htw_berlin.KinderCareConnect.rest.model.auth.LoginRequest;
import de.htw_berlin.KinderCareConnect.rest.model.auth.SignupRequest;
